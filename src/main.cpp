...
// Copyright (c) 2013 The Photoncoin developers
...
uint256 hashGenesisBlock("0x189a598f3ec9813f8c0ac0d6de2c80bf4e266c12c462ea4b14f8cd258b90430f");
static const unsigned int timeGenesisBlock = 1389093149       ;
...
const string strMessageMagic = "Photoncoin Signed Message:\n";
...
static const int64 nTargetTimespan = 300; //5* 60; // 5 minute
static const int64 nTargetSpacing = 30; // 15 seconds  //PHO:block generation
static const int64 nInterval = nTargetTimespan / nTargetSpacing; // 10 blocks  //PHO:
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "Start PHO";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x331d5f1f95181c4e35ab820f565963eac02a5297a4f55fe5260ea1ab1b934547"));
...
unsigned char pchMessageStart[4] = { 0xfd, 0xf3, 0xb5, 0xbe };//PHO:
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PhotoncoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PhotoncoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("PhotoncoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("photoncoin-miner");
    ...
    try { loop {
        ...
        printf("Running PhotoncoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("PhotoncoinMiner terminated\n");
        throw;
    }
}
