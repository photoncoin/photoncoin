...
const QString BITCOIN_IPC_PREFIX("photoncoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click photoncoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start photoncoin: click-to-pay handler");
    else
...
{
    // clicking on photoncoin: URLs creates FileOpen events on the Mac:
